...
const Country = ({country, leagues, countryAmount, countriesBySport}) => {
        ...
        <>
            <div onClick={() => {
                ...
                <div className={classes.countryRight}>
                    ...
                    <div className={classes["country-arrow"]}>
                        <svg className={`${isOpen && classes.arrowRotate}`} width="8" height="16" viewBox="0 0 8 16" fill="none"
            ...
            </div>
            {
                isOpen ? eventByLeagues.map(([league, eventByLeagues], index) => {
                    return <League league={league} key={index} leaguesAmount={eventByLeagues.length} countriesBySport={countriesBySport} eventByLeagues={eventByLeagues}/>
                }) : null
            }
        </>
    )
